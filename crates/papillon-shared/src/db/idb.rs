...
/// The fixed IndexedDB database name used by Papillon.
#[cfg(target_arch = "wasm32")]
const IDB_NAME: &str = "papillon";
...
mod inner {
    ...
    /// Open (or create) the Papillon IndexedDB database.
    ///
    ...
    async fn open_db_fresh() -> Result<IdbDatabase, JsValue> {
        ...
        let on_blocked = Closure::once(|_: Event| {
            web_sys::console::warn_1(&"papillon: IndexedDB open blocked by another tab".into());
        });
