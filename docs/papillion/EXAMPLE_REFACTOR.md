...
This document shows a concrete example of migrating `pages/settings/templates_tab/mod.rs` from `bridge::invoke` to the new `PapillionService`.
...
pub fn TemplatesTab() -> impl IntoView {
    ...
    let service = use_papillion_service();  // ← Add this line
...
|--------|--------|-------|---------|
| **Imports** | `use crate::bridge;` | `use crate::service::use_papillion_service;` | Explicit about abstraction |
| **Getting service** | N/A | `let service = use_papillion_service();` | Single point of access |
...
| **Testability** | Only with full Tauri setup | Can mock `PapillionService` | Easier unit tests |
...
mod tests {
    ...
    impl PapillionService for MockTemplateService {
...
2. Add `use crate::service::use_papillion_service;`
3. Add `let service = use_papillion_service();` at component start
...
- [ ] Get service reference with `use_papillion_service()`
