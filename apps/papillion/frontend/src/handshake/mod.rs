...
//!
//! Port of `apps/papillion/src/handshake.rs` for browser environments.
...
pub async fn run_prompt(
    canvases: leptos::prelude::RwSignal<Vec<papillion_shared::Canvas>>,
    canvas_id: String,
    block_id: String,
    text: String,
) -> Result<(), String> {
    ...
    use leptos::prelude::*;
    use papillion_shared::BlockState;
